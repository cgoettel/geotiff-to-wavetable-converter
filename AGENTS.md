...
The main documentation is in [`README.md`](README.md). The following information details how to format code, run tests, and work with dependencies.

## General instructions

- `uv` is used to handle dependencies and setup the virtual environment.
